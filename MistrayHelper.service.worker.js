...
/** @type {string} */
const CACHE_VERSION = '1754753173|9407274018';
/** @type {string} */
const CACHE_PREFIX = 'MistrayHelper-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'MistrayHelper.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["MistrayHelper.html","MistrayHelper.js","MistrayHelper.offline.html","MistrayHelper.icon.png","MistrayHelper.apple-touch-icon.png","MistrayHelper.audio.worklet.js","MistrayHelper.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["MistrayHelper.wasm","MistrayHelper.pck"];
